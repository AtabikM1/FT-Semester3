...
<body class="bg-gray-50 text-gray-900 font-['Inter']">
    ...
    <section class="relative min-h-screen bg-gradient-to-br from-[#f0f8ff] to-[#e8f4ff] overflow-hidden">
        ...
        <svg class="absolute top-0 right-0 w-1/2 h-full opacity-20" viewBox="0 0 800 800" fill="none">
            ...
            <defs>
                <radialGradient id="circleGradient1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(400 400) rotate(90) scale(200)">
                    <stop offset="0%" stop-color="#4a90e2" stop-opacity="0.2"/>
                    <stop offset="100%" stop-color="#1C2056" stop-opacity="0"/>
                </radialGradient>
                <radialGradient id="circleGradient2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(600 200) rotate(90) scale(150)">
                    <stop offset="0%" stop-color="#FFB800" stop-opacity="0.15"/>
                    <stop offset="100%" stop-color="#FFD700" stop-opacity="0"/>
                </radialGradient>
                <radialGradient id="circleGradient3" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(200 600) rotate(90) scale(100)">
            ...
            <div class="flex flex-col lg:flex-row max-w-7xl mx-auto gap-8 md:gap-16 items-center">
                ...
                <div class="space-y-6 md:space-y-10 animate-slideInLeft text-center lg:text-left">
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <p class="text-lg md:text-xl text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium delay-300">
                            Your gateway to a brighter future. Connect with top companies and explore endless career opportunities with us.
                        </p>
                    </div>
                    
                    <div class="flex flex-col sm:flex-row gap-4 md:gap-6 items-center justify-center lg:justify-start delay-500">
                ...
                <div class="relative hidden lg:block animate-slideInRight">
                    <div class="absolute inset-0 bg-[#1C2056]/10 rounded-2xl blur-3xl transform rotate-6 animate-pulse"></div>
    ...
    <section class="relative bg-white py-24 overflow-hidden">
        ...
        <div class="container mx-auto px-6 lg:px-20 relative">
            ...
            <div class="mt-20 text-center scroll-animate animate-fadeInUp delay-900">
                <a href="/browse-jobs" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-[#1C2056] rounded-xl hover:bg-amber-400 hover:text-[#1C2056] transition-all duration-300 transform hover:scale-105 shadow-lg group">
    ...
    <section class="relative bg-gradient-to-br from-[#1C2056] to-[#2d317a] py-24 overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden">
            ...
            <!-- Abstract Lines -->
            <svg class="absolute top-1/2 left-0 w-[30rem] h-64 text-white/5" viewBox="0 0 400 200" fill="none" stroke="currentColor">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute -bottom-10 left-0 w-full">
                <svg class="w-full h-24 text-white/5" viewBox="0 0 1440 100" preserveAspectRatio="none">
                    <path fill="currentColor" d="M0,50 C150,20 350,0 500,10 C650,20 800,40 1000,30 C1200,20 1400,10 1440,0 L1440,100 L0,100 Z"></path>
                </svg>
            </div>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div class="flex-1 text-center lg:text-left">
                    ...
                    <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0">
                        Join thousands of professionals who've found their dream jobs through PolinemaCareer. Your future starts here.
                    </p>
                ...
                <div class="flex justify-between items-center gap-6 lg:max-w-7xl">
                    <div class="rounded-xl shadow-lg relative">
                        <img src="./asset/Good team-bro.png" alt="Call To Action" class="relative z-10 w-[120%] h-[400px] object-cover rounded-xl">
                        <span class="absolute inset-0 w-full h-full bg-gradient-to-br from-black/50 to-transparent rounded-xl z-20"></span>


                        <span class="absolute top-2 left-2 w-full h-full bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-xl"></span>
                        <span class="absolute top-2 left-6 w-full h-full bg-gradient-to-br from-blue-500/30 to-teal-500/30 rounded-xl"></span>
                        <span class="absolute -top-3 -left-12 w-full h-full bg-gradient-to-br from-amber-500/30 to-orange-500/30 rounded-xl"></span>
                        <span class="absolute top-4 -left-16 w-full h-full bg-gradient-to-br from-emerald-500/30 to-lime-500/30 rounded-xl"></span>
                    </div>
                </div>
            </div>
        </div>
