...
<body>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-40 pt-20">
            <div class="text-center opacity-0 animate-fadeInUp">
                ...
                <p class="text-xl text-gray-200 max-w-3xl mx-auto">
                    <span class="text-amber-400">Bridging the gap</span> between talent and opportunity, empowering
                    Polinema students and alumni
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="space-y-8 opacity-0 animate-fadeInUp animate-delay-1">
                    <div
                        class="transform hover:scale-105 transition-transform duration-300 bg-white rounded-xl shadow-lg p-8 border-l-4 border-[#1C2056]">
                    ...
                    <div
                        class="transform hover:scale-105 transition-transform duration-300 bg-white rounded-xl shadow-lg p-8 border-l-4 border-amber-400">
                        <h2 class="text-3xl font-bold text-[#1C2056] mb-4 flex items-center">
    ...
    <section class="py-20 bg-gray-50 relative overflow-hidden">
        <!-- Decorative Elements -->
        <div
            class="absolute top-0 right-0 w-64 h-64 bg-amber-100 rounded-full filter blur-3xl opacity-50 transform translate-x-32 -translate-y-16">
        </div>
        <div
            class="absolute bottom-0 left-0 w-64 h-64 bg-blue-100 rounded-full filter blur-3xl opacity-50 transform -translate-x-32 translate-y-16">
        </div>
    ...
    <section class="py-20 bg-gradient-to-r from-[#1C2056] to-[#2d317a] text-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <div class="max-w-3xl mx-auto opacity-0 animate-fadeInUp">
                ...
                <p class="text-xl text-gray-200 mb-8">Join PolinemaCareer today and take the first step towards your
                    dream
                    career</p>
